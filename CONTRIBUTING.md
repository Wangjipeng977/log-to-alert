...
# 2. Clone your fork
git clone https://github.com/<your-username>/Log To Alert.git
cd Log To Alert
...
git add .
git commit -m "feat(log-to-alert): add <brief description>"

# 5. Push to your fork
git push origin feat/<your-feature-name>

# 6. Open a Pull Request on GitHub
#    - Title: feat(log-to-alert): add <brief description>
